                    ...
                    this.props.items.map((item, index) => {
                        return <div className="flex bg-white p-4 rounded mb-2" key={item.value.id}>
                            ...
                            <div className="flex-auto">
                                ...
                                <div className="float-right"><button onClick={this.deleteItem.bind(this, item.value.id)} type="button"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
