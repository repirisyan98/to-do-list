  ...
  render() {
    return (
      <main className="font-sans" >
        <div className="container mx-auto bg-gray-300 w-10/12 md:w-1/2 p-8 rounded">
          <h1 className="text-2xl">Welcome Back, User</h1>
          <div className="flex justify-between">
            <div><small>You've got {this.state.items.length} task comming up</small></div>
            <div>
              <small>{this.state.itemsComplete} <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block" fill="none" viewBox="0 0 30 30" stroke="currentColor" stroke-width="2">
